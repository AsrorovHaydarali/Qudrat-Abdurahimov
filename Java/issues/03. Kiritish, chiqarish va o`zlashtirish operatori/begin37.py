...
Ular orasidagi dastlabki masofa s0.
Avtomobillar bir-biriga tomon harakatlana boshlasa,
...
t = input("Ularning bir-biriga tomon harakatlanish vaqtni kiriting (soat): ")
...
try:
    ...
    if v1 >= 0 and v2 >= 0 and s0 >= 0 and t >= 0:
        ...
        natija = f"\n{s0} km masofadan bir-biriga tomon {v1} km/soat va {v2} km/soat tezlikda harakatlanayotgan avtomobillarning orasidagi masofa {t} soatdan keyin {s1} km ga teng bo`ladi."
    else:
        natija = "\nNoto`g`ri qiymat kiritildi."
