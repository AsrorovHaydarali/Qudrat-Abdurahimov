...
Massivning index1 va index2 indexlar orasidagi sonlarning o`rta arifmetik qiymatini chiqaruvchi dastur tuzilsin.
...
try:
    ...
    if n > 0:
        ...
        natija += f"\n\n{index1} va {index2} oralig`idagi sonlar ro`yxati esa:"
        ...
        oraliq_sonlar = sonlar[min_index : max_index + 1]
        orta_arifmetik = sum(oraliq_sonlar) / len(oraliq_sonlar)
